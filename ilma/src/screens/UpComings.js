    ...
    return (
        <ScrollView style={{
            ...
            <View style={{ height: 150, backgroundColor: Colors.THEME_COLOR, borderBottomLeftRadius: 60, borderBottomRightRadius: 60, justifyContent: "center", alignItems: "center" }}>
                <Text style={{ fontSize: FontSize.FONT_SIZE_24, color: 'white', fontWeight: "bold" }}>Up-Coming Tours</Text>
            </View>
            <View style={{ flexDirection: "row" }}>
                <Text style={{ fontSize: FontSize.FONT_SIZE_16, color: Colors.THEME_COLOR, margin: 20, fontWeight: "bold" }}>Up-Coming Tours</Text>
                <View style = {{ height : 40 ,width : 40 , borderRadius : 20 ,justifyContent : "center" , alignItems : "center" , backgroundColor : Colors.THEME_COLOR , position : "absolute" , right : 20 , top : 10 }}>
